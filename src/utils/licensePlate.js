export default [
    ...
    '津A', '津B', '津C',
    '沪A', '沪B', '沪C', '沪D', '沪R',
    '冀A', '冀B', '冀C', '冀D', '冀E', '冀F', '冀G', '冀H', '冀J', '冀R', '冀S', '冀T',
    '豫A', '豫B', '豫C', '豫D', '豫E', '豫F', '豫G', '豫H', '豫J', '豫K', '豫L', '豫M', '豫N', '豫P', '豫Q', '豫R', '豫S', '豫T', '豫U',
    '云A', '云A-V', '云C', '云D', '云E', '云F', '云G', '云H', '云J', '云K', '云L', '云M', '云N', '云P', '云Q', '云R', '云S',
    '辽A', '辽B', '辽C', '辽D', '辽E', '辽F', '辽G', '辽H', '辽J', '辽K', '辽L', '辽M', '辽N', '辽P',
    '黑A', '黑B', '黑C', '黑D', '黑E', '黑F', '黑G', '黑H', '黑J', '黑K', '黑L', '黑M', '黑N', '黑P', '黑R',
    '湘A', '湘B', '湘C', '湘D', '湘E', '湘F', '湘G', '湘H', '湘J', '湘K', '湘L', '湘M', '湘N', '湘U',
    '皖A', '皖B', '皖C', '皖D', '皖E', '皖F', '皖G', '皖H', '皖J', '皖K', '皖L', '皖M', '皖N', '皖P', '皖Q', '皖R', '皖S',
    '鲁A', '鲁B', '鲁C', '鲁D', '鲁E', '鲁F', '鲁G', '鲁H', '鲁J', '鲁K', '鲁L', '鲁M', '鲁N', '鲁P', '鲁Q', '鲁R', '鲁S', '鲁U', '鲁V',
    ...
    '陕A', '陕B', '陕C', '陕D', '陕E', '陕F', '陕G', '陕H', '陕J', '陕K', '陕V',
    ...
    '川A', '川B', '川C', '川D', '川E', '川F', '川H', '川J', '川K', '川L', '川M', '川N', '川P', '川Q', '川R', '川S', '川T', '川U', '川V', '川W', '川X', '川Y', '川Z',
